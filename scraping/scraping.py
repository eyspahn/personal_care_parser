...
def parse_ingredient_search_page(driver, page_num):
    ...
    for i in range(len(pt)):
        ...
        a_tag.click()
        scrape_chemical_page(driver, page_num)
        time.sleep(10)
        driver.back()
        pt = driver.find_elements_by_class_name('product-tile')
...
def scrape_chemical_page(driver, search_page_num):
    ...
    out_filename = 'chemical_search_page' + str(search_page_num) + '.csv'
    with open(out_filename, 'a+') as f:
        ...
        # chemical_writer = csv.writer(f)
        # chemical_writer.writerow([datetime.now(),
        #                           search_page_num,
        #                           chemical_name,
        #                           score_url,
        #                           data_availability,
